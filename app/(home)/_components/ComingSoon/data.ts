export const PRODUCT_ITEMS = [
    {
        ...
        imagePath: '/assets/images/products/product-token.png',
        isAvailable: false,
        description:
    ...
    },
    {
        ...
        imagePath: '/assets/images/products/product-revenue.png',
        isAvailable: false,
        description:
    ...
    },
    {
        ...
        imagePath: '/assets/images/products/product-launchpad.png',
        isAvailable: false,
        description:
